...
def _shell_cwd() -> str:
    """Working directory for user shell commands: the Code Workspace root when
    one is set + still usable, else the user's home (the prior default). Lets the
    in-app terminal start in the project the user is working on."""
    try:
