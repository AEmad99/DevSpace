...
const _TOKEN_SCOPES = [
  ...
  { key: 'files:read',        label: 'Files read',        detail: 'List + read files in the Code Workspace folder' },
  { key: 'files:write',       label: 'Files write',       detail: 'Create + overwrite files in the Code Workspace folder' },
];
