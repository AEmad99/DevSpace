...
_VISION_MODEL_KEYWORDS = (
    ...
    # MiniMax M-series accept image input (verified: MiniMax-M3 describes images).
    # Lets the app feed generated images back so the model can see/judge them.
    "minimax-m", "minimax-vl",
)
