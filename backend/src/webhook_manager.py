...
class WebhookManager:
    ...
    def client(self) -> httpx.AsyncClient:
        """Lazily-built httpx.AsyncClient. Created on first access so the
        client binds to whatever loop is currently running (typically the
        one uvicorn started after WebhookManager.__init__ ran at import
        time)."""
