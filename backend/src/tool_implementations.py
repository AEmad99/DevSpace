...
async def do_manage_settings(content: str, owner: Optional[str] = None) -> Dict:
    ...
    try:
        ...
        _ALIASES_SET = {
            ...
            "max rounds": "agent_max_rounds", "max steps": "agent_max_rounds",
            "step budget": "agent_max_rounds", "agent steps": "agent_max_rounds",
            "auto continue": "agent_auto_continue", "auto-continue": "agent_auto_continue",
            "keep going": "agent_auto_continue",
            "auto continue ceiling": "agent_max_rounds_ceiling", "step ceiling": "agent_max_rounds_ceiling",
            "max rounds ceiling": "agent_max_rounds_ceiling",
            "subagents": "agent_subagents_enabled", "sub agents": "agent_subagents_enabled",
            "sub-agents": "agent_subagents_enabled", "spawn agent": "agent_subagents_enabled",
            "subagent rounds": "agent_subagent_max_rounds", "subagent steps": "agent_subagent_max_rounds",
